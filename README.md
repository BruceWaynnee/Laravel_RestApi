...
- run these command to generate Laravel vendor folder 
...
- open your project and enjoy it, since this is about RestFul API, make sure to use any api testing
...app for example: PostMan, Katalon Studio, Eggplant ...
